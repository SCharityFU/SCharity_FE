...
export function FeaturedCampaignsSection() {
  const { data: campaigns, isLoading } = useGetCampaignsQuery({ limit: 6, sortBy: 'raisedAmount', sortOrder: 'ASC' });
    ...
    <section className="py-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 text-black/40">Hiện chưa có chiến dịch nào.</div>
        ) : (
