    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 w-full max-w-sm">
      {successMessage ? (
        <div className="p-6 bg-green-50 rounded-xl border border-green-200 text-center space-y-4">
          ...
          <p className="text-sm text-green-600 font-google-sans-medium">{successMessage}</p>
          <button
            type="button"
        ...
        <>
          <div className="space-y-1">
            <label className="text-sm font-google-sans-bold text-zinc-800 uppercase tracking-wider">Họ và Tên</label>
            <input
              {...register('fullName')}
              type="text"
