...
export default function KycVerificationPage() {
  ...
  const renderCameraOrUpload = (facingMode: "user" | "environment", title: string, subtitle: string, allowUpload: boolean = true) => (
  ...
  return (
    <div className="min-h-[85vh] pt-28 pb-16 px-4 flex flex-col items-center bg-gray-50/50">
      <div className="max-w-3xl w-full mx-auto glass-card rounded-3xl p-6 sm:p-10 border border-gray-100 shadow-xl overflow-hidden relative">
        ...
        {step === "INTRODUCTION" && (
          <div className="flex flex-col items-center text-center max-w-lg mx-auto">
            ...
            <h1 className="text-3xl font-black text-black mb-4">
              <HighlightText variant="underline" color="primary">Xác Thực Danh Tính</HighlightText>
            </h1>
            <p className="text-gray-600 mb-8 leading-relaxed">
              Để đảm bảo an toàn và tính minh bạch cho nền tảng SCharity, chúng tôi yêu cầu xác thực danh tính cho việc rút quỹ và các thao tác quan trọng. Quá trình này chỉ mất khoảng 2 phút.
            </p>
            ...
            <div className="w-full bg-blue-50/50 border border-blue-100 rounded-2xl p-5 mb-8 text-left">
              ...
              <ul className="space-y-3 text-sm text-blue-800/80">
                <li className="flex items-start">
                  <div className="w-5 h-5 rounded-full bg-blue-200 text-blue-700 flex items-center justify-center text-xs font-bold mr-3 shrink-0 mt-0.5">1</div>
                  <span>Chứng minh nhân dân (CMND) hoặc Căn cước công dân (CCCD) bản gốc, còn hạn sử dụng.</span>
                </li>
                <li className="flex items-start">
                  <div className="w-5 h-5 rounded-full bg-blue-200 text-blue-700 flex items-center justify-center text-xs font-bold mr-3 shrink-0 mt-0.5">2</div>
        ...
        {/* Step: Front ID */}
        {step === "FRONT_ID" && 
          renderCameraOrUpload("environment", "Chụp mặt trước CCCD/CMND", "Vui lòng đặt giấy tờ trong khung, đảm bảo rõ nét, không bị chói sáng hoặc mất góc.")
        }

        {/* Step: Back ID */}
        {step === "BACK_ID" && 
          renderCameraOrUpload("environment", "Chụp mặt sau CCCD/CMND", "Tiếp theo, hãy chụp mặt CÒN LẠI của giấy tờ. Vui lòng đảm bảo rõ nét mã QR hoặc dấu vân tay.")
        }

        {/* Step: Selfie */}
        {step === "SELFIE" && 
          renderCameraOrUpload("user", "Chụp ảnh khuôn mặt", "Hướng khuôn mặt trực diện vào camera, không đeo kính râm hay khẩu trang.", false)
        }
        ...
        {step === "REVIEW" && (
          <div className="flex flex-col items-center w-full">
            ...
            <p className="text-gray-600 mb-8 text-center text-sm">Vui lòng đảm bảo tất cả hình ảnh đều rõ nét và có thể đọc được thông tin.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-10">
              ...
              <div className="flex flex-col items-center">
                <div className="w-full aspect-[4/3] rounded-xl overflow-hidden bg-gray-100 shadow-sm border border-gray-200 relative group">
                  <img src={`data:image/jpeg;base64,${images.front}`} alt="CCCD Mặt trước" className="w-full h-full object-cover" />
              ...
              <div className="flex flex-col items-center">
                <div className="w-full aspect-[4/3] rounded-xl overflow-hidden bg-gray-100 shadow-sm border border-gray-200 relative group">
                  <img src={`data:image/jpeg;base64,${images.back}`} alt="CCCD Mặt sau" className="w-full h-full object-cover" />
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <button 
              ...
              <div className="flex flex-col items-center">
                <div className="w-full aspect-[4/3] rounded-xl overflow-hidden bg-gray-100 shadow-sm border border-gray-200 relative group">
                  <img src={`data:image/jpeg;base64,${images.selfie}`} alt="Selfie" className="w-full h-full object-cover" />
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <button 
