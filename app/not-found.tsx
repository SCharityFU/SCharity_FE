            ...
            <img 
                ...
                onError={(e) => {
                    ...
                    if (target.parentElement) {
                        target.parentElement.innerHTML = '<div class="w-full h-full flex flex-col items-center justify-center text-rose-200 border-2 border-dashed border-rose-200 rounded-2xl"><span class="text-xs">/public/assets/<br/>404 Error Page.webp</span></div>';
                    }
                }}
            />
        </div>
