---
description: FCam UI Theme Rules & Design System — guiding consistent UI across the entire app
---

# FCam — AI Instructor Theme Rules

> This document defines the design system, typography, colors, spacing, and component patterns for the FCam platform. **Every page, component, and layout must follow these rules** to maintain a cohesive, premium look.
...
| `AnimatedThemeToggle`                                                  | `@/components/ui/animated-theme-toggle` | _(Not used — light mode only)_                  |
